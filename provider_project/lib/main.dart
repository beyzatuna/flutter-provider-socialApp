...
void main() async {
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(apiKey: 'AIzaSyDKkv6YHgd4mvpF0BITOOblTCUcsAhaPFs', appId: '1:615230523314:android:23ae92789b8b0df97d86ab', messagingSenderId: '615230523314', projectId: 'test-e6741',)
  );
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Your App',
      home: EntrepreneurProfilePage(userId: '',),
      routes: {
